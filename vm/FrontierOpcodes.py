...
from vm.AbstractClass import OpcodeAPI
from vm import OpcodeValues as opcode_values
...
FRONTIER_OPCODES: Dict[int, OpcodeAPI] = {
    ...
    # Sha3
    #
    opcode_values.KECCAK256: as_opcode(
        logic_fn=sha3.keccak256,
        mnemonic=mnemonics.KECCAK256,
        gas_cost=constants.GAS_KECCAK256,
    ),
    #
    ...
    # According to EIP-4399, the DIFFICUTY operation code has been replaced
    # by the PREVRANDAO operation code.
